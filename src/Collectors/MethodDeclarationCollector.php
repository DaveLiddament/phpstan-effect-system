 ...
 *
 * @implements Collector<InClassMethodNode, array{key: string, class: string, name: string, file: string, line: int, effects: list<string>, effectFree: list<string>, handles: list<string>, abstract: bool}>
 */
