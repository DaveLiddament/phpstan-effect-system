 ...
 *
 * @implements Collector<InFunctionNode, array{key: string, class: null, name: string, file: string, line: int, effects: list<string>, effectFree: list<string>, handles: list<string>, abstract: bool}>
 */
