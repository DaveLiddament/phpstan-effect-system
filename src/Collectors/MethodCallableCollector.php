 ...
 * CallCollector.
 *
 * @implements Collector<MethodCallableNode, array{caller: string, line: int, callees: list<array{key: string, calledClass: string|null, method: string|null, dispatch: bool}>}>
 */
